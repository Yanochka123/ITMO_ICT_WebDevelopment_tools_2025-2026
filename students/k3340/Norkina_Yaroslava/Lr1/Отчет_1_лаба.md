...
<img width="980" height="469" alt="image" src="https://github.com/user-attachments/assets/29072f52-058b-456b-a3c0-cc51cc8cf920" />
...
8. daily_schedules — Ежедневное расписание
...
10. user_preferences — Настройки пользователя
...
11. sessions — Сессии авторизации
...
Создание базы данных. После установки самой программы POstgres, регистрации через PgAdmin и настройки пользователя, пароля, можно переходить к созданию самой базы данных для сервиса. 
...
После создания базы данных необходимо прописать в отельном файле db.py подключение к ней через SQLModel:
```Python
# app/database.py
import os
